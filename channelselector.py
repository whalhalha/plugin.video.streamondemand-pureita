...
def channels_list():
    ...
    itemlist.append( Item( title="Asian Sub-Ita"      , channel="asiansubita"           , language="IT"    , category="F,S"   , type="generic"))
    itemlist.append( Item( title="Casa-Cinema"         , channel="casacinema"           , language="IT"    , category="F,S,A,VOS"   , type="generic"))
    ...
    #itemlist.append( Item( title="Documoo"      , channel="documoo"           , language="IT"    , category="D"   , type="generic"))
    itemlist.append( Item( title="Eurostreaming"       , channel="eurostreaming"           , language="IT"    , category="F,S"    , type="generic"))
    itemlist.append( Item( title="Fastvideo.tv"        , channel="fastvideotv"       , language="IT"    , category="B,F"       , type="generic"))
    itemlist.append( Item( title="FilmGratis.cc"       , channel="filmgratiscc"           , language="IT"    , category="F"   , type="generic"))
    itemlist.append( Item( title="FilmStream.org"          , channel="filmstream"           , language="IT"    , category="F,S"   , type="generic"))
    itemlist.append( Item( title="FilmStream.to"       , channel="filmstreampw"           , language="IT"    , category="F,S"   , type="generic"))
    ...
    #itemlist.append( Item( title="ildocumento.it"      , channel="ildocumento"           , language="IT"    , category="D"   , type="generic"))
    itemlist.append( Item( title="ItaFilm.tv"      , channel="itafilmtv"           , language="IT"    , category="F,S,A,D"   , type="generic"))
    itemlist.append( Item( title="Italia-Film.co"      , channel="italiafilm"           , language="IT"    , category="F,S,A"   , type="generic"))
    itemlist.append( Item( title="Italian-Stream "        , channel="italianstream"       , language="IT"    , category="F,S"       , type="generic"))
...
def get_thumbnail_path(preferred_thumb=""):
    ...
    if preferred_thumb=="":
        ...
        if thumbnail_type=="0":
            WEB_PATH = "https://raw.githubusercontent.com/Fenice82/images/master/posters/"
        elif thumbnail_type=="1":
            WEB_PATH = "https://raw.githubusercontent.com/Fenice82/images/master/banners/"
        elif thumbnail_type=="2":
            WEB_PATH = "https://raw.githubusercontent.com/Fenice82/images/master/squares/"
    else:
        WEB_PATH = "https://raw.githubusercontent.com/Fenice82/images/master/"+preferred_thumb+"/"
