...
def getmainlist(preferred_thumb=""):
    ...
    itemlist.append( Item(title="Biblioteca" , channel="libreria" , action="mainlist", thumbnail = urlparse.urljoin(get_thumbnail_path(preferred_thumb),"thumb_biblioteca.png")) )
