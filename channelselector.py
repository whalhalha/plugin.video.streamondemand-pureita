...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]Cine-hd-Streaming.[/COLOR]"         , channel="cinehdstreaming"           , language="IT"    , category="F"   , type="generic",thumbnail="https://cinehdstreaming.files.wordpress.com/2015/08/cropped-cinema-2.jpg"))
    ...
    itemlist.append( Item( title="[COLOR azure]Saint Seiya[/COLOR]"     , channel="saintseiya"       , language="IT"    , category="A", type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]VediSerie[/COLOR]"        , channel="vediserie"       , language="IT"    , category="S"       , type="generic"))
