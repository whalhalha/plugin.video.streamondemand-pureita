...
def test_video_exists( page_url ):
    logger.info("[videomega.py] test_video_exists(page_url='%s')" % page_url)
    
    return True,""

def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("[videomega.py] get_video_url(page_url='%s')" % page_url)
    ...
    logger.info("[videomega.py] location="+location)
    ...
    for video_url in video_urls:
        logger.info("[videomega.py] %s - %s" % (video_url[0],video_url[1]))
...
def find_videos(data):
    ...
    logger.info("[videomega.py] find_videos #"+patronvideos+"#")
