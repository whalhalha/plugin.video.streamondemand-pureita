...
def mainlist( item ):
    ...
    itemlist.append( Item( channel=__channel__, title="[COLOR azure]Film - HD[/COLOR]", action="peliculas", url="http://www.casa-cinema.org/?s=[HD]", thumbnail="http://jcrent.com/apple%20tv%20final/HD.png" ) )
