...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append( Item(channel=__channel__, title="Tutte Le Serie Tv", action="peliculas", url="http://www.italiaserie.co/", thumbnail="http://xbmc-repo-ackbarr.googlecode.com/svn/trunk/dev/skin.cirrus%20extended%20v2/extras/moviegenres/New%20TV%20Shows.png"))
    itemlist.append( Item(channel=__channel__, title="Serie TV - Top 10", action="peliculas2", url="http://www.italiaserie.co/top-10/", thumbnail="http://i.imgur.com/cnnUCXh.png"))
    itemlist.append( Item(channel=__channel__, title="Sezione Cartoni Animati - Anime", action="peliculas", url="http://www.italiaserie.co/genere/anime-e-cartoni/", thumbnail="http://orig09.deviantart.net/df5a/f/2014/169/2/a/fist_of_the_north_star_folder_icon_by_minacsky_saya-d7mq8c8.png"))
...
def anime(item):
    ...
    for scrapedurl,scrapedtitle in matches:
        ...
        scrapedthumbnail = ""
        if (DEBUG): logger.info("title=["+scrapedtitle+"], url=["+scrapedurl+"], thumbnail=["+scrapedthumbnail+"]")
        itemlist.append( Item(channel=__channel__, action="animelink", title="" + scrapedtitle + "" , url=scrapedurl , thumbnail=scrapedthumbnail , plot=scrapedplot , folder=True) )
