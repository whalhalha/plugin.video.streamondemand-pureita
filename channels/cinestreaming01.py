...
def mainlist(item):
    ...
    itemlist.append( Item(channel=__channel__, title="Film Per Categoria", action="categorias", url=sito, thumbnail="http://xbmc-repo-ackbarr.googlecode.com/svn/trunk/dev/skin.cirrus%20extended%20v2/extras/moviegenres/All%20Movies%20by%20Genre.png"))
